...
const CLOUDINARY_CONFIG = {
  cloudName: "dj9x3cvkd",
  uploadPreset: "SVGT-Products", // Upload preset from screenshot
  apiKey: "636229656612982", // Your API key from the screenshot
};
  ...
  const getSubCategories = () => {
    switch (formData.category) {
      ...
      case "Water Tanks":
        return [
          "Overhead Tanks - 500L",
          "Overhead Tanks - 1000L",
          "Overhead Tanks - 1500L",
          "Underground Tanks - 1000L",
          "Underground Tanks - 2000L",
          "Sump Tanks",
          "Septic Tanks",
        ];
      case "Bathware":
  ...
  const handleImageUpload = async (event) => {
    ...
    try {
      for (const file of files) {
        ...
        formData.append("folder", "svgt-products/items"); // Organize in folders
          ...
          <div className="item-add-screen">
            ...
            <div className="form-container">
              <form className="item-form">
                {/* General Details */}
                <div className="section-header">Product Information</div>
                ...
                <div className="form-row-3">
                  ...
                  <div className="form-group">
                    ...
                    >
                      ...
                      <option value="Water Tanks">Water Tanks & Storage</option>
                      <option value="Bathware">Bathware Accessories</option>
                      <option value="Bathroom Accessories">
                        Bathroom Accessories & Sensors
                      </option>
                  ...
                  {/* Sub-category dropdown - shows only when category is selected */}
                  {formData.category && (
                    <div className="form-group">
                ...
                <div className="form-row-4">
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      value={formData.size}
                      onChange={handleChange}
                      placeholder="e.g., 1 inch, 2x4 feet"
                    />
                  </div>
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      placeholder="e.g., PVC, Ceramic, Stainless Steel"
                    />
                  </div>
                </div>
                ...
                <div className="form-group">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    placeholder="Enter technical specifications like dimensions, pressure rating, thread type, etc."
                    rows="3"
                  />
                </div>
                    ...
                    <div className="file-input-container">
                      ...
                      <div className="file-input-help">
                        <small>
                          ...
                          per image • Multiple images allowed
                        </small>
                      </div>
                    </div>
                    {uploading && (
